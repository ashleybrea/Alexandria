...
function ProfileHeader() {
  ...
  const [pronouns, setPronouns] = useState('she/her/hers');
  const [location, setLocation] = useState('Los Angeles');
  const [profileImg, setProfileImg] = useState(process.env.PUBLIC_URL + '/ariana-grande.png');
      ...
      <div className="profile-info">
        {editing ? (
          ...
          <>
            ...
            <div className="profile-location">📍 {location}, CA</div>
          </>
        )}
        <div className="profile-details">
          <div className="detail-section">
            ...
            <div className="sub-text">since May 2025</div>
          </div>
          <div className="detail-section">
            <h4>Department</h4>
...
export function MentorProfileHeader({ name, pronouns, location, profileImg, role, department, education }) {
  return (
    <div className="profile-header">
      <div className="profile-image" style={{ position: 'relative' }}>
        <img src={profileImg} alt={name} />
